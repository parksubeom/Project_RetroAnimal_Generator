...
function Manual() {
  ...
  return (
    <div className='sidebutton_Group'>
      {manualsound ? <audio src='https://mscojl24.github.io/Project_RetroAnimal_Generator/audio/manual1.mp3' autoPlay={manualsound}></audio> : null}
      {modal ? <Modal handleOnClick={handleOnClick} /> : null}
      {bell ? <audio src='https://mscojl24.github.io/Project_RetroAnimal_Generator/audio/bell.mp3' autoPlay={bell}></audio> : null}
      <div>
      ...
      {audio ? <audio src='https://mscojl24.github.io/Project_RetroAnimal_Generator/audio/lemon.mp3' autoPlay={audio} loop="loop"></audio> : null}
    </div>
  )
}
